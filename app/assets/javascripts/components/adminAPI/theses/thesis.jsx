class Thesis extends React.Component{
    ...
    handleEdit(){
        if(this.state.editable){
            ...
            let t = {id: id, title: title, content: content, teacher_id: teacher_id};
    ...
    render(){
        ...
        let content = this.state.editable ? <textarea required={true} type='text'className="input is-medium"  ref={input => this.content = input} defaultValue={this.props.thesis.content}/>:<i>{this.props.thesis.content}</i>;
