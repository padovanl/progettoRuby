class Thesis extends React.Component{
    ...
    render(){
        ...
        let content = this.state.editable ? <textarea style={{height:300}} required={true} type='text'className="input is-medium"  ref={input => this.content = input} defaultValue={this.props.thesis.content}/>:<i>{this.props.thesis.content.substring(0,100).concat("...")}</i>;
